...
export class VegetablesFruitsVegetablesPage implements OnInit {
    ...
    onSubmit() {
      ...
      if (!this.vegetables.type || !this.vegetables.variety || !this.vegetables.title || this.vegetables.price1kg === null || !this.vegetables.mobile) {
      ...
      formData.append('stock', this.vegetables.stock !== null ? this.vegetables.stock.toString() : '');
      ...
      formData.append('price1kg', this.vegetables.price1kg !== null ? this.vegetables.price1kg.toString() : '');
      formData.append('price5kg', this.vegetables.price5kg !== null ? this.vegetables.price5kg.toString() : '');
      formData.append('price10kg', this.vegetables.price10kg !== null ? this.vegetables.price10kg.toString() : '');
      ...
      this.http.post('http://localhost/Govi-Nena-Home-Garden-Advertisement-Module-Backend/add_vegetables.php', formData, {
        withCredentials: true
      }).subscribe({
        next: (response) => {
          console.log('Response:', response);
          this.presentToast('Vegetables advertisement successfully submitted.', 'success');
