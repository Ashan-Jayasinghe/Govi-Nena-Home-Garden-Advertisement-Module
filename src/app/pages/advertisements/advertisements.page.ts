...
//   //   console.log('Filtered Advertisements:', this.filteredAdvertisements); // Log filtered ads
//   // }
//   // Filter the advertisements by subcategory or search query
...
//       const matchesQuery = this.searchQuery ? ad.title.toLowerCase().includes(this.searchQuery.toLowerCase()) || ad.description.toLowerCase().includes(this.searchQuery.toLowerCase()) : true;
