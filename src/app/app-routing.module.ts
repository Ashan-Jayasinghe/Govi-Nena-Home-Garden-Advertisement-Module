...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./pages/advertisement-page/advertisement-page.module').then(
        (m) => m.AdvertisementPagePageModule
      ),
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./pages/post-ad-home-page/post-ad-home-page.module').then(
        (m) => m.PostAdHomePagePageModule
      ),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  // {
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./pages/fertilizers-organic/fertilizers-organic.module').then(
        (m) => m.FertilizersOrganicPageModule
      ),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  {
    ...
    loadChildren: () =>
      import('./pages/fertilizers-inorganic/fertilizers-inorganic.module').then(
        (m) => m.FertilizersInorganicPageModule
      ),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  {
  ...
  },
  {
    ...
    loadChildren: () =>
      import(
        './pages/planting-materials-seeds/planting-materials-seeds.module'
      ).then((m) => m.PlantingMaterialsSeedsPageModule),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  {
    ...
    loadChildren: () =>
      import(
        './pages/planting-materials-seedlings/planting-materials-seedlings.module'
      ).then((m) => m.PlantingMaterialsSeedlingsPageModule),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  {
    path: 'agro-chemicals',
  ...
  },
  {
    ...
    loadChildren: () =>
      import(
        './pages/agro-chemicals-pesticides/agro-chemicals-pesticides.module'
      ).then((m) => m.AgroChemicalsPesticidesPageModule),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  {
    ...
    loadChildren: () =>
      import(
        './pages/agro-chemicalss-plant-growth-regulators/agro-chemicalss-plant-growth-regulators.module'
      ).then((m) => m.AgroChemicalssPlantGrowthRegulatorsPageModule),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },

  {
    ...
    loadChildren: () =>
      import(
        './pages/machineries-and-equipment/machineries-and-equipment.module'
      ).then((m) => m.MachineriesAndEquipmentPageModule),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  {
    path: 'machineries-tractors',
    loadChildren: () =>
      import('./pages/machineries-tractors/machineries-tractors.module').then(
        (m) => m.MachineriesTractorsPageModule
      ),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  {
    ...
    loadChildren: () =>
      import('./pages/machineries-tillage/machineries-tillage.module').then(
        (m) => m.MachineriesTillagePageModule
      ),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  {
    ...
    loadChildren: () =>
      import(
        './pages/machineries-irrigation-systems/machineries-irrigation-systems.module'
      ).then((m) => m.MachineriesIrrigationSystemsPageModule),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  {
    path: 'machineries-sprayers',
    loadChildren: () =>
      import('./pages/machineries-sprayers/machineries-sprayers.module').then(
        (m) => m.MachineriesSprayersPageModule
      ),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  {
    ...
    loadChildren: () =>
      import('./pages/machineries-dryers/machineries-dryers.module').then(
        (m) => m.MachineriesDryersPageModule
      ),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  {
    ...
    loadChildren: () =>
      import(
        './pages/machineries-harvesting-machines/machineries-harvesting-machines.module'
      ).then((m) => m.MachineriesHarvestingMachinesPageModule),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  {
    ...
    loadChildren: () =>
      import(
        './pages/machineries-planting-machines/machineries-planting-machines.module'
      ).then((m) => m.MachineriesPlantingMachinesPageModule),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  {
    path: 'machineries-other',
    loadChildren: () =>
      import('./pages/machineries-other/machineries-other.module').then(
        (m) => m.MachineriesOtherPageModule
      ),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  {
    ...
    loadChildren: () =>
      import(
        './pages/planting-materials-tubers/planting-materials-tubers.module'
      ).then((m) => m.PlantingMaterialsTubersPageModule),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  {
    path: 'signup',
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./pages/advertisement-view/advertisement-view.module').then(
        (m) => m.AdvertisementViewPageModule
      ),
    canActivate: [AuthGuard], // Add the guard here to protect the route
  },
  {
    path: 'saved-ads',
    loadChildren: () =>
      import('./pages/saved-ads/saved-ads.module').then(
        (m) => m.SavedAdsPageModule
      ),
  },
  {
